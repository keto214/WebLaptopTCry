...
namespace WatchStore.Controllers
{
    public class SiteController : Controller
    {
        ...
        public ActionResult Index(String slug = "")
        {
            ...
            else if (slug.Equals("Dưới 5triệu") || slug.Equals("Từ 5 - 10 triệu") || slug.Equals("Từ 10 - 15 triệu") || slug.Equals("Từ 15 triệu"))
            {
        ...
        public ActionResult ProductPrice(String slug, int pageNumber)
        {
            ...
            double start = 0;
            double end = 0;
            if (slug.Equals("Dưới 5 triệu"))
            {
                end = 5000000;
            }
            else if (slug.Equals("Từ 5 - 10 triệu"))
            {
                start = 5000000;
                end = 10000000;
            }
            else if (slug.Equals("Từ 10 - 15 triệu"))
            {
                start = 10000000;
                end = 15000000;
            }
            else if (slug.Equals("Từ 15 triệu"))
            {
                start = 15000000;
                end = 1000000000000;
            }
